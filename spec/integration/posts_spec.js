...
describe("routes : posts", () => {
    ...
    describe("guest using CRUD actions", () => {
        beforeEach((done) => {
            User.create({
    ...
    describe("member performing CRUD actions", () => {
        beforeEach((done) => {
            User.create({
                email: "admin@example.com",
                password: "123456",
    ...
    describe("owner performing CRUD actions", () => {
        beforeEach((done) => {
            User.create({
                email: "admin@example.com",
                password: "123456",
    ...
    describe("admin performing CRUD actions", () => {
        beforeEach((done) => {
            User.create({
                email: "admin@example.com",
                password: "123456",
                ...
                request.post(options, (err, res, body) => {
                    Post.findOne({ where: { title: "Watching snow melt" } })
                        .then((post) => {
                            ...
                            expect(this.post.body).toBe("Without a doubt my favorite thing to do besides watching paint dry");
